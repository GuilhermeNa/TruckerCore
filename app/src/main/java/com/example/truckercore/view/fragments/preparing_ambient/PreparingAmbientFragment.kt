...
class PreparingAmbientFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_preparing_ambient, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PreparingAmbientFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PreparingAmbientFragment().apply {
