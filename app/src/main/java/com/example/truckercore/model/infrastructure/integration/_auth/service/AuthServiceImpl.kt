package com.example.truckercore.model.infrastructure.integration._auth.service
...
) : com.example.truckercore.model.infrastructure.integration._auth.service.AuthService {

    override suspend fun createUserAndVerifyEmail(credential: com.example.truckercore.model.infrastructure.integration._auth.entity.EmailCredential) =
