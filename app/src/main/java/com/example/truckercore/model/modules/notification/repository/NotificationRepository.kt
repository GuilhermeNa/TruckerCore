...
internal interface NotificationRepository : Repository {
    ...
    override fun fetchByDocument(documentParams: DocumentParameters): Flow<AppResponse<NotificationDto>>

    override fun fetchByQuery(queryParams: QueryParameters): Flow<AppResponse<List<NotificationDto>>>
