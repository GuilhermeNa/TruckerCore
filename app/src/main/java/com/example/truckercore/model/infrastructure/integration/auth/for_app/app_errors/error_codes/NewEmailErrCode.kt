...
sealed class NewEmailErrCode : AuthErrorCode {
    ...
    data object WeakPassword : NewEmailErrCode() {
        override val name = "WEAK_PASSWORD"
        override val userMessage = "Senha inválida."
        override val logMessage = "Weak password. Please provide a valid password"
     ...
     */
    data object TaskFailure : NewEmailErrCode() {
