package com.example.truckercore.model.infrastructure.integration._auth.app_errors.error_codes
...
sealed class ObserveEmailValidationErrCode : AuthErrorCode {
     ...
     */
    data object UserNotFound : com.example.truckercore.model.infrastructure.integration._auth.app_errors.error_codes.ObserveEmailValidationErrCode() {
