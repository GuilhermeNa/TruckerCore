package com.example.truckercore.model.infrastructure.integration.data.for_app.app_errors.error_codes

import com.example.truckercore.model.infrastructure.integration.data.for_app.app_errors.DataErrorCode
import com.example.truckercore.model.infrastructure.integration.data.for_app.specification.Specification

/**
 * Sealed class representing error codes related to data retrieval operations.
 *
 ...
 */
sealed class DataFindErrCode : DataErrorCode {

    /**
     * Error indicating that the [Specification] could not be interpreted correctly.
     */
    data object Interpretation : DataFindErrCode() {
     ...
     */
    data object InvalidData : DataFindErrCode() {
     ...
     */
    data object Mapping : DataFindErrCode() {
     ...
     */
    data object Network : DataFindErrCode() {
     ...
     */
    data object Unknown : DataFindErrCode() {
