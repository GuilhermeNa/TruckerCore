...
import com.example.truckercore.model.infrastructure.integration._data.for_app.app_exception.error_codes.DataFindErrCode
import com.example.truckercore.model.infrastructure.integration._data.for_app.app_exception.error_codes.DataFlowErrCode
...
class DataAppErrorFactory : ErrorFactory {
     ...
     */
    fun handleFindError(e: Throwable): AppException {
        val code = when (e) {
     ...
     */
    fun handleFlowError(e: Throwable): AppException {
        val code = when (e) {
