package com.example.truckercore.infra.security.configs
...
object DefaultPermissionsProvider {
     ...
     */
    operator fun invoke(role: Role): com.example.truckercore.core.security.data.collections.PermissionSet {
        ...
        return com.example.truckercore.core.security.data.collections.PermissionSet(permissions)
    }
