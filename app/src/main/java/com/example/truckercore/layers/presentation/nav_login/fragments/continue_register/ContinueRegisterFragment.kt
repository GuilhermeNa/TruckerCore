...
import com.example.truckercore.domain.view_models.continue_register.effect.ContinueRegisterEffect
...
class ContinueRegisterFragment : CloseAppFragment() {
    ...
    private val navigator: ContinueRegisterNavigator by lazy {
        val flavorService: com.example.truckercore.core.config.flavor.FlavorService by inject()
