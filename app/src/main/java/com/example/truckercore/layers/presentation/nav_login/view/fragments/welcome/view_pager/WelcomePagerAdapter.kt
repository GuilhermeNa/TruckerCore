package com.example.truckercore.layers.presentation.nav_login.view.fragments.welcome.view_pager
...
class WelcomePagerAdapter(
    ...
    override fun createFragment(position: Int): Fragment {
        ...
        val fragmentItem = WelcomeItemFragment.newInstance(pagerDataSet[position])
        return fragmentItem
    }
