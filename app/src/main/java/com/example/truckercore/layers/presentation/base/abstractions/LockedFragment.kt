package com.example.truckercore.layers.presentation.base.abstractions
 ...
 */
abstract class LockedFragment : BaseFragment() {
     ...
     */
    private val exitManager by lazy { CloseAppManager() }
