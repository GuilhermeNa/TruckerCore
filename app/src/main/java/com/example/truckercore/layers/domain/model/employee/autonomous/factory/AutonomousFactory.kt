package com.example.truckercore.layers.domain.model.employee.autonomous.factory
...
object AutonomousFactory {
    ...
    operator fun invoke(form: EmployeeForm): Autonomous {
        return Autonomous(
            id = AutID(com.example.truckercore.domain._shared._contracts.entity.ID.generate()),
