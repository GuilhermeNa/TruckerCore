package com.example.truckercore.layers.presentation._shared.views.dialogs
...
class LoadingDialog(context: Context) : Dialog(context) {
    ...
    override fun onBackPressed() {
        Log.w(com.example.truckercore.core.config.enums.Tag.WARN.name, "onBackPressed: is disabled for LoadingDialogFragment")
    }
