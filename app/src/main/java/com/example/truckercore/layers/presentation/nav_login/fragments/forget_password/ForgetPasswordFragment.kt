...
import com.example.truckercore.core.expressions.showGreenSnackBar
...
import com.example.truckercore.presentation._shared._base.fragments.BaseFragment
import com.example.truckercore.presentation._shared.views.dialogs.LoadingDialog
import com.example.truckercore.domain.view_models.forget_password.ForgetPasswordEvent
import com.example.truckercore.domain.view_models.forget_password.ForgetPasswordViewModel
import com.example.truckercore.domain.view_models.forget_password.state.ForgetPasswordUiState
...
class ForgetPasswordFragment : BaseFragment() {
    ...
    private val stateHandler by lazy { com.example.truckercore.layers.presentation.nav_login.fragments.forget_password.ForgetPasswordUiStateHandler() }

    private val navigator by lazy {
        com.example.truckercore.layers.presentation.nav_login.fragments.forget_password.ForgetPasswordNavigator(
            findNavController()
        )
    }
    ...
    private suspend fun setEffectManager() {
        viewModel.effectFlow.collect { effect ->
            ...
            when (effect) {
                com.example.truckercore.presentation.viewmodels.view_models.forget_password.effect.ForgetPasswordEffect.ClearKeyboardAndFocus ->
                    hideKeyboardAndClearFocus(binding.fragForgetPassLayout)

                is com.example.truckercore.presentation.viewmodels.view_models.forget_password.effect.ForgetPasswordEffect.ShowMessage ->
                    showRedSnackBar(effect.message)

                com.example.truckercore.presentation.viewmodels.view_models.forget_password.effect.ForgetPasswordEffect.Navigate.BackStack -> lifecycleScope.launch {
                ...
                com.example.truckercore.presentation.viewmodels.view_models.forget_password.effect.ForgetPasswordEffect.Navigate.ToNotification ->
