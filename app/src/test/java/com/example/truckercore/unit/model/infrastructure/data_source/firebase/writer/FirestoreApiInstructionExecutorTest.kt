...
class FirestoreApiInstructionExecutorTest : KoinTest {
    ...
    private val executor: FirestoreInstructionExecutor by inject()
        ...
        startKoin {
            modules(
                module {
                    ...
                    single<FirestoreInstructionInterpreter> { mockk(relaxed = true) }
                    single { FirestoreInstructionExecutor(get(), get()) }
                }
            )
        }
    }
