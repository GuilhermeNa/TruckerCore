package com.example.truckercore.unit.modules.person.employee.driver.use_cases
...
class UpdateDriverUseCaseImplTest : KoinTest {
    ...
    private val useCase: com.example.truckercore.modules.person.employee.driver.use_cases.interfaces.UpdateDriverUseCase by inject()
            ...
            startKoin {
                modules(
                    module {
                        ...
                        single<com.example.truckercore.modules.person.employee.driver.use_cases.interfaces.UpdateDriverUseCase> {
