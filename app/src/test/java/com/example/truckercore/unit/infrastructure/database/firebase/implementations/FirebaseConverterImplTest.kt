...
class FirebaseConverterImplTest {
    ...
    private lateinit var converter: com.example.truckercore.infrastructure.database.firebase.implementations.FirebaseConverterImpl<PersonalDataDto>
    ...
    fun setup() {
        converter =
            com.example.truckercore.infrastructure.database.firebase.implementations.FirebaseConverterImpl(
                PersonalDataDto::class.java
            )
