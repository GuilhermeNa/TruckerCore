package com.example.truckercore.unit.model.modules.fleet.shared.module.licensing.repository
...
class LicensingRepositoryImplTest : KoinTest {
            ...
            startKoin {
                modules(
                    module {
                        ...
                        single<com.example.truckercore.model.modules.fleet.shared.module.licensing.repository.LicensingRepository> {
                            LicensingRepositoryImpl(get(), collection = Collection.LICENSING)
                        }
                    }
                )
            }
