...
import com.example.truckercore.model.modules.fleet.trailer.use_cases.implementations.DeleteTrailerUseCaseImpl
...
class DeleteTrailerUseCaseImplTest : KoinTest {

    private val requiredPermission = Permission.DELETE_TRAILER
    ...
    private val useCase: DeleteTrailerUseCase by inject()
            ...
            startKoin {
                modules(
                    module {
                        ...
                        single<DeleteTrailerUseCase> {
                            DeleteTrailerUseCaseImpl(
                                Permission.DELETE_TRAILER,
                                get(), get(), get()
                            )
                        }
                    }
