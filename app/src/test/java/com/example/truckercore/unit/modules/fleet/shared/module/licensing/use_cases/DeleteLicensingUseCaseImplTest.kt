...
class DeleteLicensingUseCaseImplTest {
    ...
    private lateinit var useCase: DeleteLicensingUseCase
    ...
    fun `should delete entity when have permission and data exists`() = runTest {
        // Arrange
        every { permissionService.canPerformAction(user, Permission.DELETE_LICENSING) } returns true
